...
void
Socket::inetPton(const char* host, struct sockaddr_in& saddr_in)
{
#ifdef _WIN32
	WCHAR wsz[64];
...
void
Socket::setUdpTimeout(uint32_t msec)
{
#ifdef _WIN32
