...
/// Raised on decryption failure. Does not have a "reason", as libSodium doesn't offer that.
...
/// Raised on encryption failure. Does not have a "reason", as libSodium doesn't offer that.
